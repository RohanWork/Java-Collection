...
//Note : For the list implementation using ArrayList<>() and LinkedList<>() all the methods 
//		 for adding, removing, and iterate an elements are same. Only the difference in syntax.
//		 eg. 
