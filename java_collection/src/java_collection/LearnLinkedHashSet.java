...
// Note: It applies the all properties of hashset.
//		 And also it applies the linkedlist property
//		 In which order the user add elements it will reflects in that manner
//		 eg: user added 10, 11, 12, 13, etc. then it will print as same order
